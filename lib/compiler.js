...
var fncs ={
	filter:function(predicate) {
		return function filter(coll) { console.log(arguments); return _.filter(coll, predicate)};
	},
	not: function(expression) {
		return function not() { console.log(arguments); return !expression.call(this, arguments) }
	},
